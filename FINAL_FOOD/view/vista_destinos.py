...
class VistaDestinos(VistaPrincipalDestinos):
    def __init__(self, master=None, controlador=None):

        super().__init__(master, controlador)

        titulo_fuente = Font(size=13, weight="bold")
        titulo = ttk.Label(self, text="Explorar destinos", font=titulo_fuente, foreground='#0097e8')
        ...
        for index, opcion in enumerate(OPCIONES):
            ttk.Radiobutton(
                ...
                command=self.actualizar_destinos
